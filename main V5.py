...
# workmode = 1 -> automatisch werken
# workmode = 2 -> max stroom instellen via gui
# workmode = 3 -> niet laden
# workmode = 4 -> debug mode
workmode = 1
...
# Workmode 1 = automatisch laadpaal sturen a.d.h.v. slimme meter
        if workmode == 1:
                ...
                if telegram_line[0:9] == "1-0:2.7.0":               #injectie uit telegrammen halen
                    ...
                    if injectieWatt > 0:
                        ...
                        if overschotinjectie < 0:
                            ...
                            regs = c.write_single_register(1000, 0)
# Workmode 2 = max stroom zelf instellen via gui
        elif workmode == 2:
            print("workmode 2")
# Workmode 3 = niet laden
        elif workmode == 3:
            print("Laadpaal niet laden.")
            regs = c.write_single_register(1000, 0)
# Workmode 4 = debug mode
        elif workmode == 4:
            print("Debug/programming mode enabled.")
    ser.close()
